...
namespace CourseAppMicroservice.Shared.Filters;
...
public class ValidationFilter<T>: IEndpointFilter
{
    ...
    {
        // What to do before the endpoint method runs.
        // await next(context);
        // What to do after the Endpoint method runs.
